---
description: >-
  This is the current full list of in game rules that apply when you play the
  server.
---
...
{% hint style="danger" %}
Failure to comply with these rules will result in permanent removal of access to the voice chat system! The communication rules also apply within voice chats.
{% endhint %}
...
* Full bright
* Zoom Mod
* Mini Maps that do not display entities, players, or underground structures
* _Most_ quality of life mods
